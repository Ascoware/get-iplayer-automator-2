...
tie %Config, 'Config', {
    archlibexp => relocate_inc('.../../lib/5.36.0/darwin-2level'),
    ...
    osvers => '22.2.0',
    path_sep => ':',
    privlibexp => relocate_inc('.../../lib/5.36.0'),
    scriptdir => relocate_inc('.../'),
    sitearchexp => relocate_inc('.../../lib/site_perl/5.36.0/darwin-2level'),
    sitelibexp => relocate_inc('.../../lib/site_perl/5.36.0'),
    so => 'dylib',
    useithreads => undef,
